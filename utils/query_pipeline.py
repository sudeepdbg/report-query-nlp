...
def validate(sql: str, intent: QueryIntent) -> tuple[str, Optional[str]]:
    ...
    Performs injection guard + region sanity check.
    (Full schema column check requires a live DB connection — optional.)
    """
    ...
    # Region sanity: ensure all mentioned regions are canonical
    for r in intent.regions:
