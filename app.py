...
with st.sidebar:
    ...
    <div style="text-align:center;padding:1rem 0">
        <div style="font-size:1.8rem;font-weight:800;color:#fff">🔑</div>
        <div style="font-size:1.1rem;font-weight:700;color:#fff;margin-top:.25rem">Foundry Vantage</div>
        <div style="font-size:.75rem;color:#94a3b8;margin-top:.25rem">Rights Explorer · v5.0</div>
    </div>
    """, unsafe_allow_html=True)
...
def db_suggested_queries(key_prefix: str = "sug"):
    ...
    st.markdown('<div style="background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:14px 16px;margin-bottom:12px"><div style="font-size:.8rem;font-weight:700;color:#6366f1;text-transform:uppercase;letter-spacing:.06em;margin-bottom:10px">💡 Suggested queries — Rights Explorer schema</div></div>', unsafe_allow_html=True)
    cols = st.columns(4)
